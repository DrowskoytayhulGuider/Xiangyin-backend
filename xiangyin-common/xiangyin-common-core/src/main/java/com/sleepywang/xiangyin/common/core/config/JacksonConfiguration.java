package com.sleepywang.xiangyin.common.core.config;
...
import com.sleepywang.xiangyin.common.core.jackson.PigLongModule;
 ...
 * {@link com.sleepywang.xiangyin.common.core.jackson.PigJavaTimeModule}、默认时区等
 *
 * @author L.cm
 * @author lengleng
 * @author lishangbu
...
public class JacksonConfiguration implements WebMvcConfigurer {
	...
	/**
	 * 增加GET请求参数中时间类型转换 {@link com.sleepywang.xiangyin.common.core.jackson.PigJavaTimeModule}
	 * <ul>
